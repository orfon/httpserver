...
var {StatisticsHandler, ContextHandlerCollection} = org.eclipse.jetty.server.handler;

/**
 * A ContextHandlerCollection with one or more Handlers attached.
 */
var Context = module.exports = function Context(mountpoint, options) {
    var parentContainer = new ContextHandlerCollection();
